...
class Logo extends React.Component {
    render() {
        ...
        return(
            <>
                <svg id="logoloc" width="500" height="500"  viewBox={viewBox2}>
                    <path className="logo" d="M51.78,5.81L32.32,58.36l21.99,60.83H36.05L17.71,64.43h-0.73v68.03H2.45V16.03h14.53v38.58h0.73L34.1,5.81
		C34.1,5.81,51.78,5.81,51.78,5.81z"/>
                    <path className="logo" d="M80.08,119.18H50.91L48.5,5.81h29.04l2.41,11.62h-14.2v14.84h13.81v11.74H65.75v50.33h14.32L80.08,119.18
		L80.08,119.18z"/>
                    <path className="logo" d="M129.94,163.81H77.69V50.44H91.5v100.98h11.07V73.35h13.55v78.07l3.95,0.12c3.62,0.11,6.61-2.79,6.61-6.41
		V64.91l14.47-3.05l-0.25,92.3C141.24,159.64,135.89,163.99,129.94,163.81z"/>
                    <path className="logo" d="M153.71,132.45V96.47h-12.52l-1.74,22.34l-12.71,0.37V37.36c0-4.65,0.28-8.39,0.84-11.23
