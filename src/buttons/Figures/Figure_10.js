...
import "./ForFigure_10.css";
class PlyamWeather extends React.Component {
    render() {
        const viewBox2 =[0, 0, 668.98, 297.64]
        return(
            <>
                <svg id="plyamweatherloc" viewBox={viewBox2} transform="scale(-1 1)" transform-origin="250 250">
                    <path fill={this.props.fill} transform={this.props.transform} d="M633.32,158.9c-57.21-101.46-85.81-152.2-126-158c-74.54-10.77-160.34,96.88-170,109
